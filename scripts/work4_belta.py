...
PARK_SPOT_WAYPOINTS = {'1': [Point(1.951, 1.130, 0.010), Quaternion(0.0, 0.0, 0.0, 1.0)],
                       ...
                       '3': [Point(1.884, -0.439, 0.010), Quaternion(0.0, 0.0, 0.0, 1.0)],
                       '4': [Point(1.937, -1.249, 0.010), Quaternion(0.0, 0.0, 0.0, 1.0)],
...
class PushBox(smach.State):
    ...
    def execute(self, userdata):
        ...
        if box_is_left:
            ...
            util.move(-0.2, linear_scale= 0.2)
            self.go_to_side('box_front')

            #push_dist = (abs( int(current_box_stall_id)- int(self.goal_stall_id)) + 1) * square_dist - 0.4
            push_dist = abs(current_box_stall_id - self.goal_stall_id) * SQUARE_DIST + AMCL_APPROACH_BOX
    ...
    def fine_tune(self, box_is_left, ori_push_dist):
        ...
        util.move(-ori_push_dist, linear_scale = 0.2)
