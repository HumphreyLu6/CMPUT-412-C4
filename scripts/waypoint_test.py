...
class Navigate(smach.State):
    ...
    def get_waypoints(self):
        waypoints = [((0.067, -1.550, 0.010), [0.0, 0.0, 0.195, 0.981]), #on ramp
                     ...
                     ((1.951, 1.130, 0.010), [0.0, 0.0, 0.0, 1.0]),  #park1  
                     ((1.925, 0.324, 0.010), [0.0, 0.0, 0.0, 1.0]),  #park2
                     ((1.854, -0.439, 0.010), [0.0, 0.0, 0.0, 1.0]),  #park3
                     ((1.907, -1.249, 0.010), [0.0, 0.0, 0.0, 1.0]),  #park4
                     ((1.975, -2.025, 0.010), [0.0, 0.0, 0.0, 1.0]), #park5
